...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val play_btn : Button = findViewById(R.id.play)
        val stop_btn : Button = findViewById(R.id.stop)
        val forward_btn: Button = findViewById(R.id.forward)
        val back_btn : Button = findViewById(R.id.rewind)

        val title_txt : TextView = findViewById(R.id.textView2)
